...
<head>
        <title>Capitani | Soluções em TI, Recrutamento e Seleção</title><meta charset="UTF-8" />
    ...
    <body>
        <div id="loginbox">            
            <form  class="form-vertical" id="formLogin" method="post" action="<?php echo base_url()?>index.php/mapos/verificarLogin">
                  ...
                  <?php }?>
                <div class="control-group normal_text"> <h3><img src="<?php echo base_url()?>assets/img/logo.png" alt="Logo" title=" Capitani | Soluções em TI, Recrutamento e Seleção" width="250" height="250"/></h3></div>
